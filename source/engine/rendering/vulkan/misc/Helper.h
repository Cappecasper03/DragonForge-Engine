...
#include "engine/rendering/vulkan/assets/sRenderAsset.h"
...
namespace df::vulkan::helper
{
	...
	namespace util
	{
		...
		void           createBuffer( VkDeviceSize _size, VkBufferUsageFlags _usage_flags, VmaMemoryUsage _memory_usage, sRenderAsset::sBuffer& _buffer, VmaAllocator _memory_allocator );
	}
}
