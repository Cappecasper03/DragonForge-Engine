...
namespace df
{
	...
	public:
		...
		explicit cRenderCallback( std::string _name, const vulkan::cPipelineCreateInfo_vulkan& _pipeline, void( _callback )( const T*, Targs... ) );
		explicit cRenderCallback( std::string _name, const std::vector< vulkan::cPipelineCreateInfo_vulkan >& _pipelines, void( _callback )( const T*, Targs... ) );
